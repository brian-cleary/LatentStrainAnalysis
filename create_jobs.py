...
JobParams = {
	...
	'MergeHash': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python merge_hashq_files.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/hashed_reads/"""]},
	'CombineFractions': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python merge_hashq_fractions.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/hashed_reads/"""]},
	'GlobalWeights': {
	...
	'SplitPairs': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python split_read_pairs.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/read_partitions/ -o PROJECT_HOME/read_partitions/"""]},
	'PhylerClassify': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python phyler_classify.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/read_partitions/ -o PROJECT_HOME/phyler/"""]},
	'PhylerIdentify': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python phyler_identify.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/read_partitions/ -o PROJECT_HOME/phyler/"""]},
	'PhylerSummary': {

...
JobParams = {
	...
	'MergeHash': {
		...
		'header': ["""#BSUB -J MergeHash[1-""","""#BSUB -o PROJECT_HOME/Logs/MergeHash-Out-%I.out""","""#BSUB -e PROJECT_HOME/Logs/MergeHash-Err-%I.err""","""#BSUB -q medium""","""#BSUB -M 2097152"""],
	...
	'KmerCorpus': {
		...
		'header': ["""#BSUB -J KmerCorpus[1-""","""#BSUB -o PROJECT_HOME/Logs/KmerCorpus-Out-%I.out""","""#BSUB -e PROJECT_HOME/Logs/KmerCorpus-Err-%I.err""","""#BSUB -q medium""","""#BSUB -M 12097152"""],
	...
	'ReadPartitions': {
		...
		'header': ["""#BSUB -J ReadPartitions[1-""","""#BSUB -o PROJECT_HOME/Logs/ReadPartitions-Out-%I.out""","""#BSUB -e PROJECT_HOME/Logs/ReadPartitions-Err-%I.err""","""#BSUB -q medium""","""#BSUB -W 47:10""","""#BSUB -R 'rusage[mem=13192]'""","""#BSUB -M 20097152"""],
	...
	'MergeIntermediatePartitions': {
		...
		'array': ["""hashed_reads/""","""*.hashq.*"""],
		'header': ["""#BSUB -J MergeIntermediatePartitions[1-""","""#BSUB -o PROJECT_HOME/Logs/MergeIntermediatePartitions-Out-%I.out""","""#BSUB -e PROJECT_HOME/Logs/MergeIntermediatePartitions-Err-%I.err""","""#BSUB -q medium""","""#BSUB -W 47:10""","""#BSUB -R 'rusage[mem=25192]'""","""#BSUB -M 40097152"""],
